"""
Curated EFF / Diceware wordlist for generating memorable, high-entropy passphrases.
Contains distinct, easy-to-type, unambiguous English words.
"""
...
EFF_WORDLIST = [
    ...
    "scheme", "school", "science", "scissors", "scooter", "scope", "score", "scout", "scrap", "screen",
    ...
    "stamp", "stand", "star", "start", "state", "stay", "steak", "steel", "stem", "step",
    ...
    "total", "tourist", "toward", "tower", "town", "toy", "track", "trade", "traffic", "train",
    ...
    "useful", "useless", "usual", "utility", "vacant", "vacuum", "vague", "valuable", "valve", "van",
